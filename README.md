...
This is why I decided to create my Judo Library. I could curate consistent technique videos so watch back whenever I wanted, all in one place. Implementing a quiz feature was a logical no-brainer. Anki flashcards, Quizlet, the best memorization tools already test your recollection through spaced repetition.
...
The backend requires a PostgreSQL database. Add a `.env` file inside `/backend` with:
```
